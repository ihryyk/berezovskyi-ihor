...
public class Config2 {
  ...
  BeanB beanB() {
    return new BeanB(
        ...
        Integer.parseInt(environment.getProperty("beanB.value")));
  }
  ...
  BeanC beanC() {
    return new BeanC(
        ...
        Integer.parseInt(environment.getProperty("beanC.value")));
  }
  ...
  BeanD beanD() {
    return new BeanD(
        ...
        Integer.parseInt(environment.getProperty("beanD.value")));
  }
}
